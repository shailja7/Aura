...
export default function AuraStatus({ count, isScanning }) {
  ...
  const glowColor = isSafe ? 'shadow-[0_0_30px_rgba(158,171,154,0.6)]' : 'shadow-[0_0_30px_rgba(245,158,11,0.6)]';
  ...
  return (
    <div className="w-full h-full min-h-[300px] flex flex-col items-center justify-center bg-white/80 backdrop-blur-lg rounded-[2.5rem] border border-white/60 shadow-[0_10px_40px_-10px_rgba(46,32,24,0.2)] transition-all duration-300 ease-in-out p-6 relative">
      <h2 className="absolute top-6 left-6 text-sm font-bold tracking-wider text-[#2E2018] uppercase opacity-80 font-sans">Triggers</h2>
      ...
      {isScanning ? (
        ...
        <div className={`relative w-48 h-48 rounded-full flex flex-col items-center justify-center bg-white/90 border-2 transition-all duration-500 ${ringColor} ${glowColor} ring-4 ring-offset-4 ring-offset-transparent backdrop-blur`}>
